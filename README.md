...
**Название:** Разработка лексического и синтаксического анализатора (парсера) для заданного фрагмента языка программирования.

**Цель работы:** 
Изучить принципы построения трансляторов. Разработать программную систему, выполняющую лексический и синтаксический анализ заданного фрагмента языка программирования (лямбда-выражения Java). Освоить методы рекурсивного спуска для синтаксического анализа и реализовать алгоритм диагностики и нейтрализации синтаксических ошибок.
...
1. Выполняет лексический анализ входного текста (разбиение на токены/лексемы).
2. Выполняет синтаксический анализ полученной последовательности токенов.
3. В случае обнаружения синтаксических ошибок программа должна фиксировать их, указывать местоположение и тип, и продолжать анализ оставшегося текста с помощью алгоритма нейтрализации ошибок.
4. Предоставляет графический интерфейс для ввода текста, отображения таблицы лексем и списка обнаруженных синтаксических ошибок с возможностью перехода к месту ошибки в тексте.
